                ...
                <a class="brand" href="#">Welcome to: E- Learning Management System</a>
					<div class="nav-collapse collapse">
						<ul class="nav pull-right">
							...
							?>
							<li class="dropdown">
								<a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user icon-large"></i><?php if(isset($row['firstname'])) echo $row['firstname']." ".$row['lastname'];  ?> <i class="caret"></i></a>
